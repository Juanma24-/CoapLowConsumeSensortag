...
#define OTA_SERVER_IP() uip_ip6addr(&ota_server_ipaddr, 0xaaaa, 0, 0, 0, 0, 0, 0, 0x1) //Depende del prefijo que usemos en Gateway
...
#define OTA_BUFFER_SIZE 512                           //Modificado desde 1024 (Problemas de memoria)
